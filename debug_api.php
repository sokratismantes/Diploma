...
<head>
  ...
  <style>
    ...
    *::-webkit-scrollbar-thumb:hover { background: rgba(148,163,184,0.28); }
    ...
    .toast.info    { border-color: rgba(91,140,255,.25); }
...
<body>
  ...
  <script>
    ...
    function sendLogs() {
      ...
      const payload = {
        action: 'save_logs',
        user_id: loggedInUser?.sub || 'anonymous',
        task_id: 'python_editor_ai',
        code: getEditorValue(),
        events: events,
    ...
    function showUser(user) {
      ...
      updateAiButtonState();
      aiSetMessage("✅ Συνδέθηκες. Μπορείς να ρωτήσεις το Gemini.");
    }
    ...
    (function initResizer() {
      ...
      window.addEventListener('mousemove', (e) => {
        ...
        let leftWidth = e.clientX - shellRect.left;
        let rightWidth = shellRect.width - leftWidth - 18;
        ...
        leftWidth = shellRect.width - rightWidth - 18;
        mainLayout.style.gridTemplateColumns = `${leftWidth}px 18px ${rightWidth}px`;
      });
